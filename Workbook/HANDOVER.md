...
**Correct approach (shipped):** justified rows at _true_ aspect ratios, then measure-and-fit.
...
- Bug we hit and fixed (watch for regressions): a `let beads` declared _after_ a
